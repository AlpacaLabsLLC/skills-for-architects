# Arch Studio 1.5 studio and commercial validation
...
> Historical evidence. Test paths below refer to the pre-R4 implementation retained in Git at `b5484f7b1bc1df1f1e0915d7cd9d2fd37570d0fe`, not the current forward-only document model. R4 retirement of those tests does not establish new-model acceptance.
