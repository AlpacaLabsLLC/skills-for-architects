---
name: nyc-energy-code
description: "Find NYC Energy Conservation Code provisions and documented pathway references. Use for \"energy-code section\"; not for calculate U-values, certify energy compliance, or assume ASHRAE edition."
allowed-tools:
  - Read
  - Bash
  - WebFetch
...
Find NYC Energy Conservation Code provisions and documented pathway references. This is a read-only lookup, not professional approval.

## Contract

- **Input:** Edition, commercial/residential regime when material, section/topic.
- **Primary output:** Energy Code provision evidence.
- **Source dependencies:** `source:nyc-energy-code`.
- **Coverage:** N04; NYC scope with explicitly linked state/federal dependencies.
- **Not this operation:** Calculate U-values, certify energy compliance, or assume ASHRAE edition.
