---
name: nyc-interior-finish-requirement
description: "Find NYC requirements for interior wall or ceiling finishes. Use for \"wall finish or ceiling finish requirement\"; not for treat carpet, furniture or hanging curtains as wall finish."
allowed-tools:
  - Read
  - Bash
  - WebFetch
...
# /as:nyc-interior-finish-requirement

<!-- architecture-studio:harness-compatibility -->
> Harness note: use `/as:<skill>` on Claude Code and `$<skill>` on Codex. Resolve `<skill-root>` as the directory containing this loaded `SKILL.md` and `<plugin-root>` as the plugin root that contains `skills/`, and use equivalent native tools when host tool names differ.

Find NYC requirements for interior wall or ceiling finishes. This is a read-only lookup, not professional approval.

## Contract

- **Input:** Wall/ceiling application, occupancy and location in building if known.
- **Primary output:** Interior wall/ceiling finish requirement evidence.
...
- **Not this operation:** Treat carpet, furniture or hanging curtains as wall finish.
