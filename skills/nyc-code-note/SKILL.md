---
name: nyc-code-note
description: "Find a DOB Code Note for a bounded filing or work topic. Use for \"DOB Code Note\"; not for treat guidance as enacted law or a project approval."
allowed-tools:
  - Read
  - Bash
  - WebFetch
...
Find a DOB Code Note for a bounded filing or work topic. This is a read-only lookup, not professional approval.

## Contract

- **Input:** Work topic or Code Note title.
- **Primary output:** Code Note guidance evidence.
- **Source dependencies:** `source:nyc-code-notes`.
- **Coverage:** N12; NYC scope with explicitly linked state/federal dependencies.
- **Not this operation:** Treat guidance as enacted law or a project approval.
