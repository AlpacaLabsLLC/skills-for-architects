---
name: nyc-agency-rule
description: "Find an identified NYC agency rule. Use for \"NYC agency rule text\"; not for treat guidance or a proposed rule as an adopted rule."
allowed-tools:
  - Read
  - Bash
  - WebFetch
...
Find an identified NYC agency rule. This is a read-only lookup, not professional approval.

## Contract

- **Input:** Agency plus rule citation or unambiguous title.
- **Primary output:** Identified agency-rule evidence.
- **Source dependencies:** `source:nyc-agency-rules`.
- **Coverage:** N12; NYC scope with explicitly linked state/federal dependencies.
- **Not this operation:** Treat guidance or a proposed rule as an adopted rule.
