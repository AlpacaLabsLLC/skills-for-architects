---
name: nyc-fire-code
description: "Find an identified NYC Fire Code provision. Use for \"fire-code section\"; not for treat a Building Code provision as an FDNY operational approval."
allowed-tools:
  - Read
  - Bash
  - WebFetch
...
Find an identified NYC Fire Code provision. This is a read-only lookup, not professional approval.

## Contract

- **Input:** Edition and section or fire-safety topic.
- **Primary output:** Fire Code provision evidence.
- **Source dependencies:** `source:nyc-fire-code`.
- **Coverage:** N03; NYC scope with explicitly linked state/federal dependencies.
- **Not this operation:** Treat a Building Code provision as an FDNY operational approval.
