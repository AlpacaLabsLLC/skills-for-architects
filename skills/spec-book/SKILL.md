...
Follow [output contracts](../../tools/renderers/README.md). Bind accepted template hash/layout, audience field allowlist, sourced images, expected page counts and whether a combined PDF was requested. Keep client rendering inputs free of internal fields. Private controls, excluded values and source files never enter `delivery/`.
