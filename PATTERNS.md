...
- A **skill** supplies procedural instructions for one bounded outcome and the judgment needed to achieve it. A meaningful multistep procedure can invoke several owners with explicit handoffs; do not split useful procedures merely to satisfy a verb or line-count quota. "Workflow" is a distinct, defined term (see [terminology](rules/terminology.md#skill-workflow-and-tool)); do not use it as a synonym for "skill" or "procedure" here or elsewhere.
