...
def render(components, clusters):
    ...
    lines += ['', '## Ownership and capability checks', '',
              ...
              'Repository maintainers can run `python3 tools/validators/validate-categories.py --check-guide` to validate this generated view; this is not a customer workflow requirement.', '']
    return '\n'.join(lines)
